...
const uint8_t LEAF_NODE_HEADER_SIZE = COMMON_NODE_HEADER_SIZE +
...
void internal_node_spilit_and_insert(Table* table,uint32_t parent_page_num,uint32_t child_page_num){
...
int main(int argc,char* argv[]){
    ...
    while(true){
        ...
        Statement statement;
        switch(prepare_statemnet(intput_buffer,&statement)){
